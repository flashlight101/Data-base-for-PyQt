...
from PyQt5.QtWidgets import QWidget, QApplication, QSystemTrayIcon, QStyle, QAction, qApp, QMenu, QDialog, QLabel, QPushButton, QVBoxLayout, QLineEdit
...
class Ui_signUp(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QRect(150, 130, 90, 31))
        font = QFont()
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QLabel(Dialog)
        self.label_2.setGeometry(QRect(150, 230, 90, 31))
        font = QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QLabel(Dialog)
        self.label_3.setGeometry(QRect(150, 180, 90, 31))
        font = QFont()
        font.setPointSize(10)
        ...
        self.label_4.setAlignment(PyQt5.QtCore.Qt.AlignCenter)
